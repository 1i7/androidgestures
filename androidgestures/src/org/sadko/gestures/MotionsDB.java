...
public class MotionsDB extends ContentProvider {
	public static final Uri CONTENT_URI =Uri.parse("content://net.sadko.gestures.content"); 
	...
	static{
        ...
        sUriMatcher.addURI("net.sadko.gestures.content", "motions", MOTIONS);
        sUriMatcher.addURI("net.sadko.gestures.content", "motions/#", MOTION_ID);
